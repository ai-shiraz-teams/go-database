...
func (r *BaseRepository[T]) FindAllWithPagination(ctx context.Context, params domain.IQueryParams[T]) ([]T, int64, error) {
...
func (r *BaseRepository[T]) Count(ctx context.Context, params domain.IQueryParams[T]) (int64, error) {
