...
func (uow *MongoUnitOfWork[T]) Connect(ctx context.Context, parentEntity T, relationField string, childEntity types.IBaseModel) error {
...
func (uow *MongoUnitOfWork[T]) CreateRelation(ctx context.Context, parentIdentifier identifier.IIdentifier, relationField string, childEntity types.IBaseModel) (types.IBaseModel, error) {
...
func (uow *MongoUnitOfWork[T]) ConnectOrCreateRelation(ctx context.Context, parentIdentifier identifier.IIdentifier, relationField string, childEntity types.IBaseModel) (types.IBaseModel, error) {
	...
	var existingChild types.IBaseModel
...
func (uow *MongoUnitOfWork[T]) FindAllByQuery(ctx context.Context, queryParams *query.QueryParams[T]) ([]T, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)

	if queryParams == nil {
		queryParams = query.NewQueryParams[T]()
	}
	queryParams.PrepareDefaults()
	...
	findOptions := options.Find()
	if queryParams.ComputedLimit > 0 {
		findOptions.SetSkip(int64(queryParams.ComputedOffset))
		findOptions.SetLimit(int64(queryParams.ComputedLimit))
	}
...
func (uow *MongoUnitOfWork[T]) FindFirst(ctx context.Context, queryParams *query.QueryParams[T]) (T, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) FindAllWithProjection(ctx context.Context, queryParams *query.QueryParams[T], fields []string) ([]map[string]interface{}, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) CountDistinct(ctx context.Context, field string, queryParams *query.QueryParams[T]) (int64, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) BulkUpdatePartial(ctx context.Context, updates []BulkUpdateOperation) (BulkOperationResult, error) {
...
func (uow *MongoUnitOfWork[T]) DeleteAll(ctx context.Context, queryParams *query.QueryParams[T], hardDelete bool) (BulkOperationResult, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) BulkRestore(ctx context.Context, identifiers []identifier.IIdentifier) (BulkOperationResult, error) {
	result := BulkOperationResult{
		ProcessedIDs: []int{},
		Errors:       []error{},
	}
...
func (uow *MongoUnitOfWork[T]) GetTrashedByQuery(ctx context.Context, queryParams *query.QueryParams[T]) ([]T, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) ExistsWithQuery(ctx context.Context, queryParams *query.QueryParams[T]) (bool, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) GetDistinctValues(ctx context.Context, field string, queryParams *query.QueryParams[T]) ([]interface{}, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) Aggregate(ctx context.Context, operation AggregateOperation, field string, queryParams *query.QueryParams[T]) (interface{}, error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
	...
	if operation == AggregateVariance {
...
func (uow *MongoUnitOfWork[T]) FindAllStream(ctx context.Context, queryParams *query.QueryParams[T], batchSize int) (<-chan StreamResult[T], error) {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
	...
	go func() {
		...
		for cursor.Next(sessionCtx) {
			...
			resultChan <- StreamResult[T]{Data: entity}
		}
...
func (uow *MongoUnitOfWork[T]) ExecuteInBatches(ctx context.Context, queryParams *query.QueryParams[T], batchSize int, processor func([]T) error) error {
	collection := uow.getCollection()
	sessionCtx := uow.getSessionContext(ctx)
...
func (uow *MongoUnitOfWork[T]) setTimestampsForInterface(entity types.IBaseModel, isCreate bool, isUpdate bool) {
	v := reflect.ValueOf(entity)
	if v.Kind() == reflect.Ptr {
		v = v.Elem()
	}
...
func (uow *MongoUnitOfWork[T]) setObjectIDForInterface(entity types.IBaseModel) {
	v := reflect.ValueOf(entity)
	if v.Kind() == reflect.Ptr {
		v = v.Elem()
	}
